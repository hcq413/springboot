...
import com.hcq.spring.utils.realm.CustomFormAuthenticationFilter;
import com.hcq.spring.utils.realm.ShiroRealm;
...
//		系统默认登录成功后首次跳转的地址为，访问系统时初次使用地址，例：如果用户首次访问的是http://****/aa.html;
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(org.apache.shiro.mgt.SecurityManager securityManager) {
		...
		shiroFilterFactoryBean.setSuccessUrl("/queryAutions");
